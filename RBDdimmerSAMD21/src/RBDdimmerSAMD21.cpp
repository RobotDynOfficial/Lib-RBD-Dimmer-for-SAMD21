...
static dimmerLampSAMD21* dimmer[ALL_DIMMERS];
...
dimmerLampSAMD21::dimmerLampSAMD21(int user_dimmer_pin):
...
void dimmerLampSAMD21::timer_init(void)
{
...
void dimmerLampSAMD21::ext_int_init(void) 
{ 
...
void dimmerLampSAMD21::begin(DIMMER_MODE_typedef DIMMER_MODE, ON_OFF_typedef ON_OFF)
{
...
void dimmerLampSAMD21::setPower(int power)
{	
	if (power >= 99) 
	{
		power = 99;
...
int dimmerLampSAMD21::getPower(void)
{
...
void dimmerLampSAMD21::setState(ON_OFF_typedef ON_OFF)
{
	dimState[this->current_num] = ON_OFF;
}

bool dimmerLampSAMD21::getState(void)
{
	bool ret;
...
void dimmerLampSAMD21::changeState(void)
{
...
DIMMER_MODE_typedef dimmerLampSAMD21::getMode(void)
{
	return dimMode[this->current_num];
}

void dimmerLampSAMD21::setMode(DIMMER_MODE_typedef DIMMER_MODE)
{
	dimMode[this->current_num] = DIMMER_MODE;
}

void dimmerLampSAMD21::toggleSettings(int minValue, int maxValue)
{
	if (maxValue > 99) 
	{
    	maxValue = 99;
